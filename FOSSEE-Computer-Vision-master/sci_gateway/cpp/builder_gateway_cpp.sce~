...
tbx_build_gateway("skeleton_imageprocessing", ..
	names, ..
    files, ..
    get_absolute_file_path("builder_gateway_cpp.sce"),[],["-L/usr/lib -lopencv_core -L/usr/lib -lopencv_highgui -L/usr/lib -lopencv_imgproc -L/usr/lib -lopencv_nonfree -L/usr/lib -lopencv_objdetect -L/usr/lib -lopencv_video -L/usr/lib -lopencv_calib3d"],["-I/usr/include/scilab -I/usr/include/opencv -I/usr/include/opencv2 "],"g++ ");	
endfunction
